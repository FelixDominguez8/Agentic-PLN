...
def build_prompt(context, question):
    ...
    - Ignora contenido que dependa de figuras o imágenes
    - Responde en el mismo idioma de la pregunta
    - Si la pregunta pide una definición, usa la oración que define explícitamente el término
    - No mezcles varias definiciones si ya existe una clara

    Al final, escribe SOLO las fuentes que realmente utilizaste.
...
def agent_respond(query):
    ...
    system_prompt = (
        "Eres un experto en epidemiología. "
        "Responde usando únicamente el contexto proporcionado, "
        "respetando toda la información y detalle que contiene. "
