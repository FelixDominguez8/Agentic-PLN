...
# ---------------- CONFIG ----------------
pdf_files = ["Cardiologia Fundamental.pdf", "Cardiología y Cirugía Cardiovascular.pdf", "Libro-guía del Residente de Cardiologia.pdf", "Manual de Conducta y Terapeutica Cardiovascular.pdf"]
chunk_size = 500
